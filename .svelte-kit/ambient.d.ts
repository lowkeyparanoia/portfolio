...
declare module '$env/static/private' {
	...
	export const CLAUDE_INTERNAL_FC_OVERRIDES: string;
	...
	export const HEADROOM_CACHE_TTL: string;
	export const HEADROOM_COMPRESSION: string;
	export const HEADROOM_DEBUG: string;
	export const HEADROOM_ENABLED: string;
	export const HEADROOM_MODEL: string;
	...
	export const SPRING_HOME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GOPATH: string;
		GRADLE_HOME: string;
		HEADROOM_CACHE_TTL: string;
		HEADROOM_COMPRESSION: string;
		HEADROOM_DEBUG: string;
		HEADROOM_ENABLED: string;
		HEADROOM_MODEL: string;
