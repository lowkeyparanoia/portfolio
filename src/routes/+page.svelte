<script>
  ...
  const BOOT = [
    '> Initialising system...',
    '> Loading: [AI] [Finance] [Backend] [Music] [Audio] [Visual]',
  ...
  const ROLE = 'Backend Engineer · AI/ML · Quant Trader · Music Tech · Projection Mapping';
...
<section id="av-work" class="section alt">
  <div class="container">
    ...
    <p class="sec-sub">Working at the intersection of code and real space — generating AI-assisted generative visuals in TouchDesigner, mapping them onto architecture, and operating live AV setups for performance.</p>

    <div class="term av-feature reveal" style="margin-bottom:20px">
      <div class="term-bar">
        <span class="term-btn r"></span><span class="term-btn y"></span><span class="term-btn g"></span>
        <span class="term-title">sixth_sense_bangalore.sh</span>
      </div>
      <div class="term-body av-feature-body">
        <div class="av-feature-left">
          ...
          <div class="proj-stack" style="margin-top:12px">
            ...
            <span class="tag" style="border-color:rgba(0,229,255,0.25);color:var(--cyan)">Projection Mapping</span>
            <span class="tag" style="border-color:rgba(154,108,240,0.3);color:#9a6cf0">Generative Art</span>
            <span class="tag" style="border-color:rgba(154,108,240,0.3);color:#9a6cf0">Live Performance</span>
          </div>
        </div>
    ...
    <div class="term reveal">
      <div class="term-bar">
        <span class="term-btn r"></span><span class="term-btn y"></span><span class="term-btn g"></span>
        <span class="term-title">tools_and_gear.json</span>
      </div>
      <div class="term-body">
        <div class="sk-cat">tools / gear</div>
        <div class="sk-items">
          <span class="sk-item">TouchDesigner</span>
          <span class="sk-item">LazyLighting</span>
          <span class="sk-item">Projection Mapping</span>
          <span class="sk-item">OSC Protocol</span>
          <span class="sk-item">MIDI</span>
          <span class="sk-item">AV Equipment</span>
          <span class="sk-item">Generative Art</span>
          <span class="sk-item">Live Performance</span>
        </div>
        <p style="margin-top:12px;font-size:0.78rem;color:var(--text-dim)">
          <span style="color:var(--green)">// OSC bridge:</span> Contrapunk (Rust/WASM) → TouchDesigner for music-reactive real-time visuals at live events.
        </p>
      </div>
    </div>
  </div>
...
/* ── AV WORK ────────────────────────────────────────────────── */
.av-feature-body  { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
.av-role-badge    { display: inline-block; font-size: 0.68rem; color: var(--green); border: 1px solid rgba(0,255,65,0.3); padding: 2px 10px; margin-bottom: 8px; }
.av-venue         { font-family: var(--sans); font-size: 1rem; font-weight: 700; color: #fff; margin-bottom: 10px; }
.av-desc          { font-size: 0.82rem; color: var(--text-dim); line-height: 1.65; }
.av-media-grid    { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
.av-media-item {
  aspect-ratio: 16/9; overflow: hidden;
  border-radius: var(--radius); border: 1px solid var(--border2);
  background: var(--surface); position: relative;
}
.av-media-video, .av-media-img {
  width: 100%; height: 100%;
  object-fit: cover; display: block;
  transition: transform 0.4s ease, filter 0.3s ease;
  filter: brightness(0.88);
}
.av-media-item:hover .av-media-video,
.av-media-item:hover .av-media-img {
